...
| F-002 | accepted → applied (gpt-5.5 bumped, pin reversed same day) | `0120abe` (pin annotation) → `9cdf8a2` (bumped to gpt-5.5) | 2026-05-03 same-day reversal: maintainer set "always-latest model" policy in CONTRIBUTING.md; cost concern overridden by drift-prevention principle; codex CLI 0.128 dogfood treated as ambient A/B signal |
