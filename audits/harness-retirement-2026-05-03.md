...
|---------|--------|--------|----------|
| F-001 | accepted (option 2 hybrid) → applied | (this PR) | 1006/1006 tests pass; 6 new TDD tests for fallback chain |
...
| F-007 | accepted (raise to 8192, custom.ts kept at 2048) → applied | (this PR) | 1006/1006 tests pass; no test pinned 2048 |
